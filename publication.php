...
require_once("db.php");
session_start();
$query = "SELECT * FROM a_deck WHERE status='pending' and NOT created_by='admin'";
...
<body>
    ...
    <div class="container mt-5 mb-5">
                        ...
                        <div class="back" style="color:black;">
                          ...
                          <?php echo $row['description']?> </p>
                            <div class="btn-group" role="group">
                                <a href="publish_card.php?d_id=<?php echo $row['deck_id']?>" class="btn btn-outline-secondary text-black">View cards</a>
                                <a href="approval.php?d_id=<?php echo $row['deck_id']?>&u_id=<?php echo $row['created_by']?>" class="btn btn-outline-secondary text-black ">Publish</a>
                                <a href="reject.php?d_id=<?php echo $row['deck_id']?>&u_id=<?php echo $row['created_by']?>" class="btn btn-outline-secondary text-black ">Reject</a>  
                            </div>
                          </p>
                        </div>
                    </div>
      ...
      ?>
            ...
            <!-- <div class = "footer">
                  <br><br><button id = "add" type="button" class="btn btn-dark btn-lg add" data-toggle="modal" data-target="#exampleModal">
                      Add Deck
                  </button>
                </div> -->
            <!-- <div class="col-md-4"> -->
